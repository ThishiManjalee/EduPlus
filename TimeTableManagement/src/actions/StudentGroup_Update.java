 ...
 * @author User
 */
public class StudentGroup_Update {
    public int value;
    
    public void UpdateStudentGroup(String Programme,String GroupId,String GroupNumber,String SubGroupId,String SubGroupNumber,String AcadamicYearSemester){
    
      try{
                Connection cn=connection.DB_Connect.ConnecrDB();

                String update="Update student_group set programme=?,group_id=?,group_number=?,sub_group_id=?,sub_group_number=?,acadamic_year_semester=?   where stu_id="+value; 
